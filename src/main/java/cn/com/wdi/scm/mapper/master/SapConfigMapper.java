...
public interface SapConfigMapper {
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2020-05-21T15:39:53.255+08:00", comments="Source Table: sap_config")
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2020-05-21T15:39:53.254+08:00", comments="Source Table: sap_config")
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2020-05-21T15:39:53.255+08:00", comments="Source Table: sap_config")
    default Optional<SapConfig> selectByPrimaryKey(String id_) {
        return selectOne(c ->
            c.where(id, isEqualTo(id_))
        );
    }
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2020-05-21T15:39:53.255+08:00", comments="Source Table: sap_config")
    default int updateByPrimaryKey(SapConfig record) {
        return update(c ->
            c.set(destName).equalTo(record::getDestName)
            .set(ashost).equalTo(record::getAshost)
            .set(sysnr).equalTo(record::getSysnr)
            .set(client).equalTo(record::getClient)
            .set(username).equalTo(record::getUsername)
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2020-05-21T15:39:53.256+08:00", comments="Source Table: sap_config")
    default int updateByPrimaryKeySelective(SapConfig record) {
        return update(c ->
            c.set(destName).equalToWhenPresent(record::getDestName)
            .set(ashost).equalToWhenPresent(record::getAshost)
            .set(sysnr).equalToWhenPresent(record::getSysnr)
            .set(client).equalToWhenPresent(record::getClient)
            .set(username).equalToWhenPresent(record::getUsername)
