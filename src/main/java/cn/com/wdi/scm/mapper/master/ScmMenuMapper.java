...
public interface ScmMenuMapper {
    ...
    int insertMultiple(MultiRowInsertStatementProvider<ScmMenu> multipleInsertStatement);
    ...
    @Generated(value = "org.mybatis.generator.api.MyBatisGenerator", date = "2020-03-27T16:13:29.37+08:00", comments = "Source Table: scm_menu")
    default int insertMultiple(Collection<ScmMenu> records) {
        return MyBatis3Utils.insertMultiple(this::insertMultiple, records, scmMenu, c ->
                c.map(id).toProperty("id")
                        .map(url).toProperty("url")
                        .map(path).toProperty("path")
                        .map(component).toProperty("component")
    ...
    @Generated(value = "org.mybatis.generator.api.MyBatisGenerator", date = "2020-03-27T16:13:29.371+08:00", comments = "Source Table: scm_menu")
