...
public interface ScmMenuRoleMapper {
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2020-03-27T16:13:29.372+08:00", comments="Source Table: scm_menu_role")
    ...
    int insertMultiple(MultiRowInsertStatementProvider<ScmMenuRole> multipleInsertStatement);
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2020-03-27T16:13:29.372+08:00", comments="Source Table: scm_menu_role")
    default int insertMultiple(Collection<ScmMenuRole> records) {
        return MyBatis3Utils.insertMultiple(this::insertMultiple, records, scmMenuRole, c ->
            c.map(id).toProperty("id")
            .map(mid).toProperty("mid")
            .map(rid).toProperty("rid")
        );
    ...
    @Generated(value="org.mybatis.generator.api.MyBatisGenerator", date="2020-03-27T16:13:29.373+08:00", comments="Source Table: scm_menu_role")
